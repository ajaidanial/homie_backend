...
LOCAL_APPS = [
    "homie_backend.users.apps.UsersConfig",
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "homie_backend.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "homie_backend.users.adapters.SocialAccountAdapter"
